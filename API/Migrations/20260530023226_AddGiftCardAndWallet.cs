...
{
    /// <inheritdoc />
    public partial class AddGiftCardAndWallet : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GiftCards_Users_ClaimedByUserId",
                        column: x => x.ClaimedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GiftCards_Users_SenderUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletTransactions_GiftCards_GiftCardId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GiftCards_ClaimedByUserId",
                table: "GiftCards",
                column: "ClaimedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GiftCards_SenderUserId",
                table: "GiftCards",
                column: "SenderUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_GiftCardId",
                table: "WalletTransactions",
                column: "GiftCardId");
