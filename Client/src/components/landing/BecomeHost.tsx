...
const BecomeHost: React.FC = () => {
    return (
        <section className="relative py-24 px-6 overflow-hidden bg-[#Fdfbf7]">
            {/* 1. Vintage Terrazzo / Confetti Background Pattern */}
            <div className="absolute inset-0 z-0 opacity-40">
                <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <pattern id="terrazzo" x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
                            {/* Abstract vintage shapes */}
                            <circle cx="20" cy="20" r="12" fill="#E8D4C5" /> {/* Soft clay */}
                            <path d="M50 50 L70 80 L30 80 Z" fill="#D4E2D4" transform="rotate(20 50 65)" /> {/* Sage triangle */}
                            <rect x="120" y="40" width="20" height="30" fill="#E6D2D2" transform="rotate(-15 130 55)" /> {/* Pink rect */}
                            <circle cx="160" cy="140" r="8" fill="#F0E6D2" /> {/* Sand dot */}
                            <path d="M80 150 Q100 120 120 150 T160 150" stroke="#C8D6C9" strokeWidth="4" fill="none" /> {/* Squiggle */}
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                >
                    {/* Texture Overlay for the Card (Paper Grain) */}
                    <div
                    ...
                    <div className="md:w-5/12 relative h-64 md:h-auto bg-[#F5F5F0]">
                        ...
                        {/* Washi Tape Effect holding the photo */}
                    ...
                    <div className="md:w-7/12 p-10 md:p-16 flex flex-col justify-center text-left relative">
                        ...
                        <div className="flex gap-4 items-center">
                            <button className="px-8 py-4 bg-deep-purple text-white font-medium rounded-full hover:bg-[#2A1B3D] transition-all shadow-lg">
                                Learn more
                            </button>
                        </div>
                    </div>
