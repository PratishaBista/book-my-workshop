...
import { useCategories } from '../../hooks/useWorkshopQueries';
                ...
                <div className="flex items-center gap-8">
                    {!minimal && (
                        <div className="hidden lg:flex items-center gap-6">
                            ...
                            {/* Location Picker (Outside, to the Left) */}
                                    ...
                                    <input
                                        ...
                                        onKeyDown={(e) => {
                                            if (e.key === 'Enter' && searchQuery.trim()) {
                                                setSearchOpen(false);
                                                navigate(`/workshops?q=${encodeURIComponent(searchQuery)}${selectedLocation !== 'All Locations' ? `&loc=${encodeURIComponent(selectedLocation)}` : ''}`);
                                            }
                                        }}
                                                    ...
                                                    {isSearching ? (
                                                        ...
                                                        <>
                                                                    ...
                                                                    <div className="flex-1 min-w-0">
                                                                        ...
                                                                        <div className="flex items-center gap-1.5 text-xs text-deep-purple/60">
                                                                            <span className="font-bold text-[#D94F80]">
                                                                                {/* Workshop avg rating */ '4.9'} <span className="text-[10px]">★</span>
                                                                            </span>
                                                                            <span>({/* Workshop reviews count */ Math.floor(Math.random() * 300) + 10})</span>
                                                            ...
                                                            <div className="px-4 pt-4 mt-2 border-t border-deep-purple/5">
                                                                <Link
                                                                    to={`/workshops?q=${encodeURIComponent(searchQuery)}${selectedLocation !== 'All Locations' ? `&loc=${encodeURIComponent(selectedLocation)}` : ''}`}
                                                                    onClick={() => setSearchOpen(false)}
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative" ref={userMenuRef}>
                            <button onClick={() => setUserMenuOpen(!userMenuOpen)} className="p-2 rounded-lg transition-colors relative">
                                ...
                                {userMenuOpen && (
                                    ...
                                    >
                                        ...
                                        {isAuthenticated && isCustomer ? (
                                            <>
                                                <Link to="/notifications" onClick={() => setUserMenuOpen(false)} className="w-full flex items-center justify-between px-4 py-3 rounded-lg hover:bg-cream-base text-left font-semibold">
                                                ...
                                                <Link to="/profile?tab=bookings" onClick={() => setUserMenuOpen(false)} className="w-full block px-4 py-3 rounded-lg hover:bg-cream-base text-left font-semibold">
                                                    My Bookings
                                                </Link>
                                                <Link to={username ? `/u/${username}?tab=wallet` : '/settings/edit-profile'} onClick={() => setUserMenuOpen(false)} className="w-full block px-4 py-3 rounded-lg hover:bg-cream-base text-left font-semibold">
                                                    My Wallet
                                                </Link>
                                                <Link to="/gift-cards" onClick={() => setUserMenuOpen(false)} className="w-full block px-4 py-3 rounded-lg hover:bg-cream-base text-left font-semibold">
                                                    Buy Gift Card
                                                </Link>
