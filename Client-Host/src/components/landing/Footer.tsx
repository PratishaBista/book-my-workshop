                ...
                <div className="xl:w-6/12 w-full flex flex-col md:flex-row gap-16 md:gap-24 items-start pt-4">
                    <div className="flex-1">
                        ...
                        <ul className="space-y-6 font-serif text-4xl md:text-5xl text-deep-purple tracking-tight">
                            <li><Link to="/host/dashboard">Dashboard</Link></li>
                            <li><Link to="/host/dashboard/workshops">Workshops</Link></li>
                            <li><Link to="/host/dashboard/schedule">Schedules</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="flex-1">
                        ...
                        <ul className="space-y-6 font-serif text-4xl md:text-5xl text-deep-purple tracking-tight">
                            <li><Link to="/host/settings">Settings</Link></li>
                            <li><Link to="/host/dashboard/support">Support</Link></li>
                        </ul>
